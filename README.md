...
<ol><li>Will you go through this door? (no conclusive answer)</li><li>What will the other guard answer if I ask him 'Will you go through this door?' (conclusive answer)</li></ol>
</li>
<li>The test suite contains unit tests that check both whether a question will provide a conclusive answer, and whether following this answer (or it's opposite) will lead to freedome, in all possible configurations.</li>
</ul>